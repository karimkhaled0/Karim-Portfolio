        ...
        <div className='h-screen relative flex flex-col text-center md:text-left md:flex-row max-w-7xl justify-evenly mx-auto items-center'>
            ...
            <div className='flex flex-col space-y-10 mt-24'>
                <div className='space-y-2'>
                    <h4 className='text-xl md:text-2xl xl:text-3xl font-semibold text-center uppercase'>I will create web app using</h4>
                    <h4 className='underline decoration-[#F7AB0A]/50 uppercase text-xl md:text-2xl xl:text-3xl font-semibold text-center'>reactjs, next.js, node.js and mongodb</h4>
                </div>
            ...
            <div className='h-[500px] flex flex-col w-[415px] border-white border mt-24'>
                ...
                {/* Basic */}
                {
                    basic && (
                        <div className='space-y-2'>
                            ...
                            <p className='text-center text-base font-semibold'>I will create 2 pages for your website - only Frontend</p>
                            <div className='px-8 py-5 flex items-center justify-around'>
                                ...
                                <div className='flex items-center space-x-2'>
                                    <ArrowPathIcon
                                        className='h-5 w-5 text-white'
                                    />
                                    <h4 className='text-lg font-bold'>1 Revision</h4>
                                </div>
                            </div>
                            <div className='px-5'>
                                <div className='flex items-center space-x-2'>
                                    ...
                                    />
                                    <h4 className='text-lg font-semibold'>2 Pages</h4>
                                </div>
                                <div className='flex items-center space-x-2'>
                                    <CheckCircleIcon
                                        className='h-4 w-4 text-green-600'
                ...
                {/* Standard */}
                {
                    standard && (
                        <div>
                            ...
                            <p className='text-center text-base font-semibold'>I will create a 5 pages website for you, including the Frontend and Backend integrations.</p>
                            <div className='px-8 py-5 flex items-center justify-around'>
                                <div className='flex items-center space-x-2'>
                                    <ClockIcon
                                        className='h-5 w-5 text-white'
                                ...
                                <div className='flex items-center space-x-2'>
                                    <ArrowPathIcon
                                        className='h-5 w-5 text-white'
                                    />
                                    <h4 className='text-lg font-bold'>3 Revision</h4>
                                </div>
                            </div>
                            <div className='px-5'>
                                <div className='flex items-center space-x-2'>
                                    <CheckCircleIcon
                                        className='h-4 w-4 text-green-600'
                                    />
                                    <h4 className='text-lg font-semibold'>5 Pages</h4>
                                </div>
                                <div className='flex items-center space-x-2'>
                                    <CheckCircleIcon
                                        className='h-4 w-4 text-green-600'
                ...
                {/* Premium */}
                {
                    premium && (
                        <div>
                            ...
                            <p className='text-center text-base font-semibold'>Custom Web app with up to 10 pages and custom backend</p>
                ...
                <a target={'_blank'} href="https://www.fiverr.com/karim_k9/be-your-fullstack-web-developer-using-reactjs-and-nodejs" rel="noreferrer">
